...
import (
	"fmt"
	v18 "github.com/CosmosContracts/juno/v17/app/upgrades/v18"
	"io"
	"net/http"
	"os"
	"reflect"
...
var (
	...
	Upgrades = []upgrades.Upgrade{v10.Upgrade, v11.Upgrade, v12.Upgrade, v13.Upgrade, v14.Upgrade, v15.Upgrade, v16.Upgrade, v17.Upgrade, v18.Upgrade}
)
